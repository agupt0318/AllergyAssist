...
class Fruit: UIViewController {
    ...
    let allergens : [[String]] = [["Shellfish","+"],
                                  ...
                                  ["Meat","+"],
                                  ["Fruit","+"]]
    let allergy_ls : [String] = ["Apple","Peach","Kiwi","Acerola","Apricot","Banana", "Cherry","Coconut","Date","Fig","Grape","Lychee","Mango","Melon","Orange","Pear","Persimmon","Pineapple","Pomegranate","Prune","Strawberry","Tomato","Celery","Asparagus","Avocado","Bell pepper","Cabbage","Carrot","Lettuce","Potato","Pumpkin","Turnip","Zucchini"]
